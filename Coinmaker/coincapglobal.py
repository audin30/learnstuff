...
print()
print('There are currently ' + active_currencies_string + '. ' + 'Active markets is ' + active_markets_string + '.' )
print('The global cap of all cryptos is ' + global_cap_string + ' and the 24h global volumume is ' + global_volume_string)
print('Bitcoin\'s total percentage of the global cap is ' + str(bitcoin_percentage) + '.')
print()
print('This information was last update on ' + last_updated_string + '.')
